...
> **This quickstart helps you run a _self-hosted_ instance of the Apollo Router.** If you [create a cloud supergraph](/studio/getting-started/) with Apollo GraphOS, Apollo provisions and hosts your supergraph's router for you.
>
